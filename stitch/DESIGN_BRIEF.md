...
- FluxRail Lite turns the user's request into a directly usable game workflow. The first experience must be the actual browser game behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser-game called FluxRail Lite. It should be a full-viewport rail-switching arcade game where the player routes moving light trains through a neon rail network, flips switches with keyboard or click controls, collects signal boosts, avoids dead rails, and can open a settings overlay withou…
...
- Gameplay - FluxRail Lite
- Game Settings - FluxRail Lite

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Gameplay - FluxRail Lite
...
SCREEN_SPEC_2:
- exact_screen_title: Game Settings - FluxRail Lite
